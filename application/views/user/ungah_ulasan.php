  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Unggah Ulasan
          <small>Silhakan pilih website yang akan diulas</small>
        </h1>
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
          <li class="active">Unggah Ulasan</li>
        </ol>
      </section>
      <!-- Main content -->
            ...
            <form class="" action="<?php echo base_url('c_ungah_ulasan/insert_jawaban'); ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nilai" placeholder="Masukan Nilai Tingkat Kepercayaan Anda Terhadap Newsite ini antara 1 sampai 100" name="nilai" required>
                </div>
                <div class="form-group">
